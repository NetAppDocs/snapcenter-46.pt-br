...
+
image::../media/nss_license_selection.gif[seleção de licença nss]
...
. Na seção Licença da página Software, clique em *Add* (image:../media/add_policy_from_resourcegroup.gif[""]).
