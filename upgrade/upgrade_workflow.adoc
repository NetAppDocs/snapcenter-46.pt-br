...
IMPORTANT: Por exemplo, se você estiver no SnapCenter versão 4,3.x e quiser atualizar para 4,6.x, primeiro você deve atualizar para 4,5.x e, em seguida, fazer uma atualização contínua para 4,6.x.
