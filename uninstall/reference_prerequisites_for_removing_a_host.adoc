...
Para obter informações sobre como desinstalar o SnapCenter Plug-in para VMware vSphere, consulte  https://docs.netapp.com/us-en/sc-plugin-vmware-vsphere/scpivs44_remove_plugin.html["Remova o plug-in do SnapCenter para VMware vSphere"^].
